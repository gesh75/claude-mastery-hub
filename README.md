...
- **Practice Lab** — 25 hands‑on scenario challenges: you're dropped into a real situation, type the command (or pick the move), get instant feedback + on‑demand hints, and unlock a solution walk‑through with the *why* and *when*
