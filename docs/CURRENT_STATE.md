...
| Branch | `main` |
| Last merged PR | [#32](https://github.com/gesh75/claude-mastery-hub/pull/32) — Managed Agents (core) |
| Open PRs | none |
...
| Tests | **114** — content-currency 13 · p0-responsive-navigation 16 · roadmap-dashboard 9 · persisted-state 20 · practice-lab-validation 20 · gate-hardening 6 · content-counts 3 · model-registry-rendering 10 · workflow-orchestration 8 · managed-agents 9 |
...
**Open PR 2b — Managed Agents (advanced).** Plan:
